    ...
    <div className="bg-gray-50 min-h-screen">
      ...
      <div className="bg-gradient-to-r from-navy to-navyDark text-white py-12">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <h1 className="section-title text-white text-4xl md:text-5xl mb-2">Events & Activities</h1>
          <p className="text-lg text-white/90">Join us for community gatherings, celebrations, and special occasions</p>
        </div>
      </div>
