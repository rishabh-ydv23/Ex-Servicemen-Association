...
export default function MembersAdmin(){
  ...
  const [form, setForm] = useState({ name: '', role: '', bio: '', priority: 0 })
  ...
  async function create(e: React.FormEvent){
    ...
    setForm({ name: '', role: '', bio: '', priority: 0 }); setFile(null); load()
  }
  ...
  return (
    <div className="max-w-6xl mx-auto px-4 py-10">
      <h1 className="text-2xl font-bold text-navy">Manage Head Members</h1>
