  ...
  return (
    <footer className="bg-navyDark text-white mt-auto">
        ...
        <div className="grid md:grid-cols-4 gap-8 mb-8">
          ...
          <div>
            ...
            <ul className="space-y-2 text-sm">
              ...
              <li><a href="/notifications" className="text-white/80 hover:text-white transition">Notifications</a></li>
              <li><a href="/events" className="text-white/80 hover:text-white transition">Events</a></li>
              <li><a href="/gallery" className="text-white/80 hover:text-white transition">Gallery</a></li>
            </ul>
          </div>
          ...
          <div>
            ...
            <ul className="space-y-2 text-sm text-white/80">
              <li className="flex items-start space-x-2">
                ...
                <span>913/1, Adarsh Nagar, Hiran Nagar, Unnao, Uttar Pradesh 209801</span>
              </li>
              <li className="flex items-center space-x-2">
                <svg className="w-4 h-4 flex-shrink-0" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                  <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M3 5a2 2 0 012-2h3.28a1 1 0 01.948.684l1.498 4.493a1 1 0 01-.502 1.21l-2.257 1.13a11.042 11.042 0 005.516 5.516l1.13-2.257a1 1 0 011.21-.502l4.493 1.498a1 1 0 01.684.949V19a2 2 0 01-2 2h-1C9.716 21 3 14.284 3 6V5z" />
                </svg>
                <a href="tel:+918299471336" className="hover:text-white transition">+91 82994 71336</a>
              </li>
              <li className="flex items-center space-x-2">
                <svg className="w-4 h-4 flex-shrink-0" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                  <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M3 8l7.89 5.26a2 2 0 002.22 0L21 8M5 19h14a2 2 0 002-2V7a2 2 0 00-2-2H5a2 2 0 00-2 2v10a2 2 0 002 2z" />
                </svg>
                <a href="mailto:exservicmenasso.india@gmail.com" className="hover:text-white transition">exservicmenasso.india@gmail.com</a>
              </li>
            </ul>
          </div>
          ...
          <div>
            ...
            <div className="flex space-x-4 mb-6">
              <a href="https://www.facebook.com/groups/1361858078952482/?ref=share&mibextid=KtfwRi" target="_blank" rel="noreferrer" aria-label="Facebook" className="w-10 h-10 bg-white/10 hover:bg-white/20 rounded-lg flex items-center justify-center transition">
                <svg className="w-5 h-5" fill="currentColor" viewBox="0 0 24 24">
                  <path d="M24 12.073c0-6.627-5.373-12-12-12s-12 5.373-12 12c0 5.99 4.388 10.954 10.125 11.854v-8.385H7.078v-3.47h3.047V9.43c0-3.007 1.792-4.669 4.533-4.669 1.312 0 2.686.235 2.686.235v2.953H15.83c-1.491 0-1.956.925-1.956 1.874v2.25h3.328l-.532 3.47h-2.796v8.385C19.612 23.027 24 18.062 24 12.073z"/>
                </svg>
              </a>
              <a href="https://chat.whatsapp.com/KxmeMe9UX22CqUenIZDb3T" target="_blank" rel="noreferrer" aria-label="WhatsApp" className="w-10 h-10 bg-white/10 hover:bg-white/20 rounded-lg flex items-center justify-center transition">
                <svg className="w-5 h-5" fill="currentColor" viewBox="0 0 24 24">
              ...
              <a href="mailto:exservicmenasso.india@gmail.com" aria-label="Email" className="w-10 h-10 bg-white/10 hover:bg-white/20 rounded-lg flex items-center justify-center transition">
      ...
      <button 
        ...
        className="fixed bottom-6 right-6 bg-saffron text-white w-12 h-12 rounded-full shadow-strong hover:bg-opacity-90 transition flex items-center justify-center z-40"
