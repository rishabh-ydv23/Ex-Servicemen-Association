  ...
  return (
    <div className="card card-hover overflow-hidden">
      ...
      <div className="p-5">
        ...
        <p className="text-sm text-gray-700 line-clamp-3 leading-relaxed mb-4">{e.description}</p>
        {onOpen && (
          <button 
            className="text-saffron hover:text-navy font-medium text-sm flex items-center space-x-1 group"
            onClick={() => onOpen(e)}
          >
